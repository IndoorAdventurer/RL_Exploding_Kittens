...
class EKNonAtomicReplayBuffer:
    ...
    def append(self,
        ...
        c_t_mask, cards_t = self.zero_pad(cards_t, self.cards_len)
        h_t_mask, history_t = self.zero_pad(history_t, self.hist_len)

        c_tp1_mask, cards_tp1 = self.zero_pad(cards_tp1, self.cards_len)
        h_tp1_mask, history_tp1 = self.zero_pad(history_tp1, self.hist_len)
